    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
                <span class="text-white text-lg ml-3"> GirlShop </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/cheek_product') ?>" class="side-menu side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('categories/base_makeup') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title">
                                Base Makeup
                    ...
                    <li>
                        <a href="<?= base_url('categories/eye_product') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Eye Product </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/lip_product') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Lip Product </div>
                        </a>
                    </li>

                    <li>
                        <a href="<?= base_url('categories/aksesoris') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="shopping-bag"></i> </div>
                            <div class="side-menu__title"> Aksesoris </div>
                        </a>
                    </li>

<!DOCTYPE html>
<!--
Template Name: GirlShop - HTML Admin Dashboard Template
Author: Left4code
...
<head>
    ...
    <meta name="description" content="GirlShop admin is super flexible, powerful, clean & modern responsive tailwind admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, GirlShop Admin Template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="LEFT4CODE">
    <title><?= $title ?> | GirlShop</title>
    <!-- BEGIN: CSS Assets-->
            ...
            <ul class="scrollable__content py-2">
                <li>
                    <a href="javascript:;.html" class="menu menu--active">
                        ...
                        <div class="menu_title"> Dashboard <i data-lucide="chevron-down" class="menu_sub-icon transform rotate-180"></i> </div>
                    </a>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Menu Layout <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="side-menu-light-dashboard-overview-1.html" class="menu">
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> E-Commerce <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Products <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Transactions <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Sellers <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Crud <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Users <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Profile <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Pages <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Wizards <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Blog <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Pricing <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Invoice <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> FAQ <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon"> <i data-lucide="inbox"></i> </div>
                        <div class="menu_title"> Components <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Table <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Overlay <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        ...
                        <div class="menu_title"> Forms <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                        ...
                        <li>
                            <a href="javascript:;" class="menu">
                                <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="menu_title"> Wysiwyg Editor <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                            </a>
                            <ul class="">
                                <li>
                ...
                <li>
                    <a href="javascript:;" class="menu">
                        <div class="menu__icon"> <i data-lucide="hard-drive"></i> </div>
                        <div class="menu_title"> Widgets <i data-lucide="chevron-down" class="menu_sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
